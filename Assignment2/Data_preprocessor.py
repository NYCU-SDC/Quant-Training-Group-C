...
class DataProcessor:
    def __init__(self, model_path, time_sequence=10, time_interval=1):
        ...
        self.time_sequence = time_sequence + 1  # because of the percentage change
    ...
    async def process_data(self):
        try:
            ...
            if len(self.indexprices_data) >= self.time_sequence:
                ...
                if len(self.orderbooks_data) >= self.time_sequence and len(self.bbo_data) >= self.time_sequence and len(self.trades_data) >= self.time_sequence:
